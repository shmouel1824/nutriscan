...
const TRANSLATIONS = {
  en: {
    ...
    "EfficientNetB0 model trained on 75,000+ food images": "EfficientNetB0 model trained on 75,000+ food images",
"Score tailored to your BMI, activity level & medical flags": "Score tailored to your BMI, activity level & medical flags",
"Full macro & micronutrient breakdown from USDA official data": "Full macro & micronutrient breakdown from USDA official data",
"Recommended portion size calculated just for you": "Recommended portion size calculated just for you",
"food classes": "food classes",
...
"scoring factors": "scoring factors",
  ...
  he: {
    ...
    "EfficientNetB0 model trained on 75,000+ food images": "מודל EfficientNetB0 מאומן על 75,000+ תמונות מזון",
"Score tailored to your BMI, activity level & medical flags": "ציון מותאם אישית לפי BMI, פעילות ומצב בריאותי",
"Full macro & micronutrient breakdown from USDA official data": "פירוט תזונתי מלא ממאגר USDA הרשמי",
"Recommended portion size calculated just for you": "גודל מנה מומלץ מחושב עבורך אישית",
"food classes": "קטגוריות מזון",
"model accuracy": "דיוק המודל",
"scoring factors": "גורמי ציון",
  }
};
